...
## Purifying a cell population of interest with scGate
...
Let's explore the whole tumor dataset by Jerby-Arnon et al. 2018 (https://doi.org/10.1016/j.cell.2018.09.006), with the cell type annotations provided by the authors.
```{r,collapse =T}
...
The scGate package and installation instructions are available at: [scGate packge](https://github.com/carmonalab/scGate)
