...
my_scGate_model <- edit_model(model = my_scGate_model, level = 1, positive = F, name = "platelet", signature = c("PPBPelotudo"))
...
#test_my_model(my_scGate_model, target = "CD8T")
#performance.metrics(actual = "CD8T", pred = obj$is.pure== "Pure")
```
...
my_scGate_model <- edit_model(model = my_scGate_model, level = 2, positive = F, name = "platelet", signature = c("PPBPelotudo"))
