...
plot_UCell_scores(obj = hao, model = nk.adt)

hao <- scGate(data = hao, model = nk.adt, assay = "ADT",maxRank = maxrank, pos.thr = 0.4, neg.thr = 0.6, output.col.name = "NK.adt")
...
platelet.adt <- gating_model(model = platelet.adt,name = "myeloid", signature = c("CLEC12A","HLA-DR"),negative = T)
