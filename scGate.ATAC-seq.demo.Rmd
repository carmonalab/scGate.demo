...
```{r fig.height=3,collapse=T, fig.width = 6, eval =F}
#DefaultAssay(pbmc.f) <- "GeneActivity"
#c <- FeaturePlot(object = pbmc.f, features = c('MS4A1'), reduction= "umap.atac",pt.size = 0.1,max.cutoff = 'q95') + 
#  ggtitle("MS4A1 ATAC") + theme(aspect.ratio = 1)
...
````{r fig.height=4, fig.width=9,collapse=T}
