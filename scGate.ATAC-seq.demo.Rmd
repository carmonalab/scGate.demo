...
DimPlot(pbmc, group.by = "Bcell.ATAC", reduction= "umap.atac",
             cols = palette) + ggtitle("scGate B cells on ATAC") + theme(aspect.ratio = 1)
```
...
DimPlot(pbmc, group.by = "Tcell.ATAC", reduction= "umap.atac",
             cols = palette) + ggtitle("scGate T cells on ATAC") + theme(aspect.ratio = 1)
```
...
a <- DimPlot(pbmc, group.by = "Monocyte.ATAC.level1", reduction= "umap.atac",
             cols = palette) + ggtitle("Myeloid cells (ATAC)") + theme(aspect.ratio = 1)

b <- DimPlot(pbmc, group.by = "Monocyte.ATAC", reduction= "umap.atac",
             cols = palette) + ggtitle("CD14 Monocytes (ATAC)") + theme(aspect.ratio = 1)
...
a <- DimPlot(pbmc, group.by = "NK.ATAC.level1", reduction= "umap.atac", cols = palette) +
  ggtitle("scGate Lymphoid (ATAC)") + theme(aspect.ratio = 1)

# Layer 2 (NK cells)
b <- DimPlot(pbmc, group.by = "NK.ATAC", reduction= "umap.atac", cols = palette) +
