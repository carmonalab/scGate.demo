...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "T.cell", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "T.cell", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "T.cell", dataset = "Jerby"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "B.cell", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "B.cell", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "B.cell", dataset = "Jerby"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "MonMacDC", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "MonMacDC", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "MonMacDC", dataset = "Jerby"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "T.cell", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "T.cell", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "T.cell", dataset = "Yost"))
...
d <- my.summary(actual = dataset.list$Yost$cell_type%>%grepl("B.cell",.) + 0 ,pred = (Yost.pred$SingleR.Zil$pruned.labels%>%grepl("B cells",.)) + 0)
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "B.cell", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "B.cell", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "B.cell", dataset = "Yost"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "MonMacDC", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR", target = "MonMacDC", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = d$summary$MCC, method = "SingleR.Zil", target = "MonMacDC", dataset = "Yost"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "TCD8", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR.Zil", target = "TCD8", dataset = "Jerby"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "TCD4", dataset = "Jerby"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR.Zil", target = "TCD4", dataset = "Jerby"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "TCD8", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR.Zil", target = "TCD8", dataset = "Yost"))
...
mccs <- rbind(mccs, data.frame(mcc = a$summary$MCC, method = "scGate", target = "TCD4", dataset = "Yost"))
mccs <- rbind(mccs, data.frame(mcc = b$summary$MCC, method = "SingleR.Zil", target = "TCD4", dataset = "Yost"))
...
jp <- ggplot(mccs%>%subset(dataset == "Jerby"),aes(fill=method, y=mcc, x=target)) + geom_bar(position="dodge", stat="identity") + ggtitle("Jerby")
yp <- ggplot(mccs%>%subset(dataset == "Yost"),aes(fill=method, y=mcc, x=target)) + geom_bar(position="dodge", stat="identity") + ggtitle("Yost")
jp + yp
...
t0 = Sys.time()
Jerby.pred$SingleR.Zil <- SingleR(test = GetAssayData(dataset.list$Jerby), ref = sceZil,labels = sceZil$`Most likely LM22 cell type`, BPPARAM=param)
Yost.pred$SingleR.Zil <- SingleR(test = GetAssayData(dataset.list$Yost), ref = Zil,labels = sceZil$`Most likely LM22 cell type`, BPPARAM=param)
